          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                ...
                activeOpacity={editar ? 0.7 : 1} className="absolute bottom-10 right-0 bg-secondary z-50 p-2 rounded-full shadow-md">
                <FontAwesome name="camera" size={20} color="#111" />
              </TouchableOpacity>
            ...
            <View className={`w-[${MOBILE_WIDTH - 150}] bg-zinc-800 rounded-3xl p-8 items-center`}>
              ...
              <View className="flex-row flex-wrap justify-center gap-8">
                {Object.entries(avatarComponents).map(([key, AvatarComp]) => (
                  <TouchableOpacity
                    key={key}
                    className={`p-3 rounded-xl border-2 relative ${avatarSource === key
