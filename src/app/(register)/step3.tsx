...
const Step03 = () => {
  ...
  const { avatarId, avatarSource, nome, sobrenome, email, birthDate, phone, termsAccepted, lgpdAccepted } =
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputsContainer}>
          ...
          <TextInput style={styles.input} placeholder="Digite seu email" value={email} editable={false} />
